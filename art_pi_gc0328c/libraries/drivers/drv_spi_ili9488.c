...
static rt_uint32_t BACK_COLOR = WHITE, FORE_COLOR = RED,BLUE_COLOR = BLUE;
 ...
 * @return  void
 */
void lcd_draw_line_blue(rt_uint16_t x1, rt_uint16_t y1, rt_uint16_t x2, rt_uint16_t y2)
{
    rt_uint16_t t;
    rt_uint32_t i = 0;
    ...
    if (y1 == y2)
    {
        ...
        for (i = 0; i < x2 - x1; i++)
        {
            line_buf[3 * i] = BLUE_COLOR >> 16;
            line_buf[3 * i + 1] = BLUE_COLOR >> 8;
            line_buf[3 * i + 2] = BLUE_COLOR;
        }
    ...
    {
        lcd_draw_point_color(row, col,BLUE_COLOR);
        xerr += delta_x ;
        yerr += delta_y ;
        if (xerr > distance)
        {
...
* @return  void
*/
void lcd_draw_rectangle_blue(rt_uint16_t x1, rt_uint16_t y1, rt_uint16_t x2, rt_uint16_t y2)
{
    lcd_draw_line_blue(x1, y1, x2, y1);
    lcd_draw_line_blue(x1, y1, x1, y2);
    lcd_draw_line_blue(x1, y2, x2, y2);
    lcd_draw_line_blue(x2, y1, x2, y2);
}
/**
 * display a rectangle on the lcd.
 *
